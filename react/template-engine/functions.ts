...
export function funcMultiply(args: any[]): number {
  //
  if (args.length < 2) throw new Error('multiply requires at least 2 arguments')
...
export function funcToString(args: any[]): string {
  //
  if (args.length !== 1) throw new Error('toString requires exactly 1 argument')
  return String(args[0])
}
export function funcToNumber(args: any[]): number {
  //
  if (args.length !== 1) throw new Error('toNumber requires exactly 1 argument')
...
export function funcDefault(args: any[]): any {
  //
  if (args.length !== 2) throw new Error('default requires exactly 2 arguments')
  const value = args[0]

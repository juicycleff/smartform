...
export interface HeadingProps extends Omit<BaseTypographyProps, 'align'>,
  Omit<VariantProps<typeof headingVariants>, "color"> {
  align?: "left" | "center" | "right";
}

// Paragraph specific props
export interface ParagraphProps extends Omit<BaseTypographyProps, 'align'>,
...
export interface CaptionProps extends Omit<BaseTypographyProps, 'align'>,
  Omit<VariantProps<typeof captionVariants>, "color"> {
  align?: "left" | "center" | "right";
}

// Animation wrapper for typography components
const withFadeAnimation = <P extends BaseTypographyProps>(Component: React.ComponentType<P>) => {
...
export const Heading = memo(forwardRef<HTMLHeadingElement, HeadingProps>(
  ({ className, size, color, align, as, children, ...props }, ref) => {
    ...
    const ariaProps = as && ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'].includes(String(size))
...
export const Paragraph = memo(forwardRef<HTMLParagraphElement, ParagraphProps>(
  ({ className, size, weight, color, align, font, truncate, lineClamp, as = "p", children, ...props }, ref) => {
    // Warning for incompatible props in development
    if (process.env.NODE_ENV === 'development' && truncate && lineClamp) {
      console.warn('Typography: Both truncate and lineClamp props are set. truncate will take precedence.');
    }
    ...
    return (
      <Box
        as={as}
        ref={ref}
        className={cn(paragraphVariants({ size, weight, color, align, font, truncate, lineClamp, className }))}
        dir={props.dir}
        {...props}
      >
        {children}
...
export const ParagraphLarge = memo(forwardRef<HTMLParagraphElement, Omit<ParagraphProps, "size">>(
  (props, ref) => <Paragraph ref={ref} size="large" {...props} />
));
ParagraphLarge.displayName = "ParagraphLarge";

export const ParagraphMedium = memo(forwardRef<HTMLParagraphElement, Omit<ParagraphProps, "size">>(
  (props, ref) => <Paragraph ref={ref} size="medium" {...props} />
));
ParagraphMedium.displayName = "ParagraphMedium";

export const ParagraphSmall = memo(forwardRef<HTMLParagraphElement, Omit<ParagraphProps, "size">>(
  (props, ref) => <Paragraph ref={ref} size="small" {...props} />
));
ParagraphSmall.displayName = "ParagraphSmall";

export const ParagraphXS = memo(forwardRef<HTMLParagraphElement, Omit<ParagraphProps, "size">>(
  (props, ref) => <Paragraph ref={ref} size="xs" {...props} />
));
ParagraphXS.displayName = "ParagraphXS";

// Label Components
export const Label = memo(forwardRef<HTMLSpanElement, LabelProps>(
  ({ className, size, weight, color, required, srOnly, as = "span", children, ...props }, ref) => {
    return (
      <Box
        as={as}
        ref={ref as any}
        className={cn(labelVariants({ size, weight, color, required, srOnly, className }))}
        {...props}
      >
        {children}
      </Box>
...
export const Label1 = memo(forwardRef<HTMLSpanElement, Omit<LabelProps, "size">>(
  (props, ref) => <Label ref={ref} size="1" {...props} />
));
Label1.displayName = "Label1";

export const Label2 = memo(forwardRef<HTMLSpanElement, Omit<LabelProps, "size">>(
  (props, ref) => <Label ref={ref} size="2" {...props} />
));
Label2.displayName = "Label2";

export const Label3 = memo(forwardRef<HTMLSpanElement, Omit<LabelProps, "size">>(
  (props, ref) => <Label ref={ref} size="3" {...props} />
));
Label3.displayName = "Label3";

export const Label4 = memo(forwardRef<HTMLSpanElement, Omit<LabelProps, "size">>(
  (props, ref) => <Label ref={ref} size="4" {...props} />
));
Label4.displayName = "Label4";

// Caption Component
export const Caption = memo(forwardRef<HTMLSpanElement, CaptionProps>(
  ({ className, size, color, align, as = "span", children, ...props }, ref) => {
    return (
      <Box
        as={as}
        ref={ref as any}
...
export const CaptionDefault = memo(forwardRef<HTMLSpanElement, Omit<CaptionProps, "size">>(
  (props, ref) => <Caption ref={ref} size="default" {...props} />
));
CaptionDefault.displayName = "CaptionDefault";

export const CaptionSmall = memo(forwardRef<HTMLSpanElement, Omit<CaptionProps, "size">>(
  (props, ref) => <Caption ref={ref} size="small" {...props} />
));
...
export const ScreenReaderText = memo(({ children, ...props }: HTMLAttributes<HTMLSpanElement>) => (
  <Box as="span" className="sr-only" {...props}>{children}</Box>
));
ScreenReaderText.displayName = "ScreenReaderText";

// RTL support helper
export const RTLText = memo(({ children, ...props }: HTMLAttributes<HTMLSpanElement>) => (
  <Box as="span" dir="rtl" {...props}>{children}</Box>
));
...
export function H1({children, className, ...props}: React.ComponentProps<"h1">) {
  return (
    <h1 {...props} className={`scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl ${className || ''}`}>
      {children}
    </h1>
  )
}
...
export function H2({children, className, ...props}: React.ComponentProps<"h2">) {
  return (
    <h1 {...props} className={`scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0 ${className || ''}`}>
      {children}
    </h1>
  )
}
...
export function H3({children, className, ...props}: React.ComponentProps<"h3">) {
  return (
    <h3 {...props} className={`scroll-m-20 text-2xl font-semibold tracking-tight ${className || ''}`}>
      {children}
    </h3>
  )
}
...
export function H4({children, className, ...props}: React.ComponentProps<"h4">) {
  return (
    <h4 {...props} className={`scroll-m-20 text-xl font-semibold tracking-tight ${className || ''}`}>
      {children}
    </h4>
  )
}
...
export function Blockquote({children, className, ...props}: React.ComponentProps<"blockquote">) {
  return (
    <blockquote {...props} className={`mt-6 border-l-2 pl-6 italic ${className || ''}`}>
      {children}
    </blockquote>
  )
}
...
export function Code({children, className, ...props}: React.ComponentProps<"code">) {
  return (
    <code {...props} className={`relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold ${className || ''}`}>
      {children}
    </code>
  )
}
...
export function Large({children, className, ...props}: React.ComponentProps<"p">) {
  return (
